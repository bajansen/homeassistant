...
WEATHER_SENSOR_TYPES: tuple[SensorEntityDescription, ...] = (
    ...
    SensorEntityDescription(
        ...
        translation_key="attr_api_temperature",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    ...
    SensorEntityDescription(
        ...
        translation_key="attr_api_wind_speed",
    ...
    SensorEntityDescription(
        ...
        translation_key="attr_api_humidity",
    ...
    SensorEntityDescription(
        ...
        translation_key="attr_api_pressure",
...
FORECAST_SENSOR_TYPES: tuple[SensorEntityDescription, ...] = (
    ...
    SensorEntityDescription(
        ...
        translation_key="attr_api_forecast_precipitation",
        device_class=SensorDeviceClass.PRECIPITATION,
        native_unit_of_measurement=UnitOfPrecipitationDepth.MILLIMETERS,
    ),
    SensorEntityDescription(
        key=ATTR_API_FORECAST_PRECIPITATION_PROBABILITY,
        translation_key="attr_api_forecast_precipitation_probability",
        native_unit_of_measurement=PERCENTAGE,
    ),
    SensorEntityDescription(
        key=ATTR_API_FORECAST_PRESSURE,
        translation_key="attr_api_forecast_pressure",
        native_unit_of_measurement=UnitOfPressure.HPA,
        device_class=SensorDeviceClass.PRESSURE,
    ),
    SensorEntityDescription(
        key=ATTR_API_FORECAST_TEMP,
        translation_key="attr_api_forecast_temp",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
    ),
    SensorEntityDescription(
        key=ATTR_API_FORECAST_TEMP_LOW,
        translation_key="attr_api_forecast_temp_low",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
    ),
    SensorEntityDescription(
        key=ATTR_API_FORECAST_TIME,
        translation_key="attr_api_forecast_time",
    ...
    SensorEntityDescription(
        ...
        translation_key="attr_api_cloud_coverage",
        native_unit_of_measurement=PERCENTAGE,
    ),
)
